...
function ProductChildren({ cartDataMovieTV, chimuc, value }: any) {
  interface Trailer {
    key: string | null;
  }
    ...
    <div>
      ...
      <div>
        <div
          ...
          style={{
            backgroundImage: `url('https://image.tmdb.org/t/p/w500${cartDataMovieTV[chimuc].backdrop_path}')`,
          }}
        ></div>
        <div className="single_column_backgound">
          <div className="poster-img1">
            <img
              src={`https://image.tmdb.org/t/p/w500${cartDataMovieTV[chimuc].poster_path}`}
              alt="alt"
            />
          </div>
          <div key={chimuc} className="OverVeiw">
            <div className="Title-name">{cartDataMovieTV[chimuc].title}</div>
            ...
            <div className="info-item-Cart">
              <div className="hover-percent">
                <div className="percent-cart-item1">
                  <span>{cartDataMovieTV[chimuc].vote_average.toFixed(1)}</span>
                </div>
              </div>
            ...
            <div className="info-overView">
              ...
              {cartDataMovieTV[chimuc].overview}
              <br />
